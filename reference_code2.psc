...
// 1. A�adir venta: pedimos un dia, calculamos la coordenada exacta y a�adimos la venta. En caso de que ya exista una venta, la sumamos.
	...
	mientras no salir Hacer
		...
		segun opcion hacer
			1: 
				...
				Escribir "Se ha a�adido la venta";
